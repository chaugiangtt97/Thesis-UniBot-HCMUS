...
def get_encoder_configs(code = 'ACTIVE'):
    """
    ...
    try:
        ...
        if code.upper() == 'ALL':
            configs = ApiServiceConfigs.get_encoder_configs()
        elif code.upper() == 'ACTIVE':
            configs = ApiServiceConfigs.get_encoder_configs_active()
        elif code.upper() == 'NOT_ACTIVE':
            configs = ApiServiceConfigs.get_encoder_configs_not_active()
