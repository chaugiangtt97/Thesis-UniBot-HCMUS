...
def get_queryRouter_configs(code = 'ACTIVE'):
    """
    Retrieve QUERY ROUTER configurations based on the provided code.
    ...
    try:
        ...
        if code.upper() == 'ALL':
            configs = ApiServiceConfigs.get_queryRouter_configs()
        elif code.upper() == 'ACTIVE':
            configs = ApiServiceConfigs.get_queryRouter_configs_active()
        elif code.upper() == 'NOT_ACTIVE':
            configs = ApiServiceConfigs.get_queryRouter_configs_not_active()
