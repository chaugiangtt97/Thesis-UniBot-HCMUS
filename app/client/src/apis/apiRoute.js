...
export const useApi = {
  ...
  login : (email = null, password = null, captchaToken = null ) => 
    postRequest(server_domain + authRequest, `/login` , { email, password, captchaToken }),
  ...
  postParams: 
    (token, use_history = null, max_tokens = null, filter_bias = null, threshold = null, k = null) => 
  ...
  update_profile: (token, dataUpdate = null) => 
    postRequest(server_domain + profileRequest, `/`, { dataUpdate } , token),
