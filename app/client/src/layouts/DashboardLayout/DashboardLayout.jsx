...
const DashboardContainer = styled(Box)(({ theme }) => ({
  ...
  '&::before': {
    background: '#ddf3fc', content: '""', display: 'flex', position: 'absolute', zIndex: -1, inset: 0,
    ...
    <DashboardContainer sx={(theme) => ({
      ...
      <SidebarContainer
        ...
        <InformationCard
          ...
          <Box onClick={() => navigate('/admin_profile')}
            ...
            <CardContent sx={{ display: 'flex', flexDirection: 'column', alignItems: 'center', height: '100%', py: 0, '&:last-child': { py: 0 }, position: 'relation', paddingLeft: 1 }}>
              <Typography component="div" variant="p"
                sx={{
                  width: { xl: '180px', xs: '144px' }, textAlign: 'center', overflow: 'hidden', fontSize: { xs: '0.725rem', xl: '1.225rem' }, color: theme => theme.palette.mode == 'light' ? '#000' : '#fff',
              ...
              <Typography
                sx={{
                  width: { xl: '190px', xs: '144px' }, fontSize: { xs: '0.625rem', xl: '0.875rem' }, textAlign: 'center', lineHeight: '120%', fontWeight: '400', color: theme => theme.palette.mode == 'light' ? '#505766' : 'rgb(133, 141, 160)',
          ...
          <ListItemButton onClick={() => getModal(' ', 'Are you sure you want to log out☹️?', 'Logout', logoutClick)}
            sx={{
