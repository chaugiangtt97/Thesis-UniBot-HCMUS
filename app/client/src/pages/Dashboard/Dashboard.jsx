  ...
  return (
    ...
    <CustomBlock sx={{ width: '100%', boxShadow: 'none', border: 'none', background: 'transparent', overflowX: 'hidden' }}>
      ...
      <Grid container spacing={2} direction="row"
        ...
        <Grid size={7}>
          <Box sx={{
            position: 'relative', background: theme => theme.palette.mode == 'dark' ? '#4c5486f2' : '#005181', borderRadius: '10px', height: '310px',
        ...
        <Grid size={5}>
          <Grid container spacing={2} direction="column">
            ...
            <Grid size={12}>
              <Box sx={{
                position: 'relative', background: '#eaf5ff', borderRadius: '10px',
